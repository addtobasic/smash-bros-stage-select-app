    ...
    data:()=>({
      ...
      items:[
        ...
        },
        {
          ...
          lazyImage:"https://github.com/addtobasic/smash-bros-stage-select-app/blob/main/static/stage/normal/kalosPokemonLeague.png?raw=true",
          select:true,
          firstReject:true,
          secondReject:false,
          finalReject:false,
        },
        {
          ...
          lazyImage:"https://github.com/addtobasic/smash-bros-stage-select-app/blob/main/static/stage/normal/lylat.png?raw=true",
          select:true,
          firstReject:true,
          secondReject:false,
          finalReject:false,
